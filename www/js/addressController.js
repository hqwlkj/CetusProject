/*starry*/
angular.module('starter.addressController', [])

.controller('AddCtrl', function($scope, $http, $state, $ionicLoading, $timeout, ApiEndpoint, Userinfo) {
	
})
.controller('AddresssCtrl', function($scope,$ionicPopover, $http, $state, $ionicLoading, $timeout,$ionicModal,ApiEndpoint, Userinfo) {
	//数据集合
...
//			         "重庆": {"重庆市": ["万州区", "涪陵区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "万盛区", "双桥区", "渝北区", "巴南区", "黔江区", "长寿区", "綦江县", "潼南县", "铜梁县", "大足县", "荣昌县", "璧山县", "梁平县", "城口县", "丰都县", "垫江县", "武隆县", "忠县", "开县", "云阳县", "奉节县", "巫山县", "巫溪县", "石柱土家族自治县", "秀山土家族苗族自治县", "酉阳土家族苗族自治县", "彭水苗族土家族自治县", "江津市", "合川市", "永川市", "南川市"]}};  
	$scope.addList = {'北京': {'市辖区':['东城区','西城区','崇文区','宣武区','朝阳区','丰台区','石景山区','海淀区','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区'],'县':['密云县','延庆县']},
'上海':{'市辖区':['黄浦区','卢湾区','徐汇区','长宁区','静安区','普陀区','闸北区','虹口区','杨浦区','闵行区','宝山区','嘉定区','浦东新区','金山区','松江区','青浦区','南汇区','奉贤区'],'县':['崇明县']},
'天津':{'市辖区':['和平区','河东区','河西区','南开区','河北区','红桥区','塘沽区','汉沽区','大港区','东丽区','西青区','津南区','北辰区','武清区','宝坻区'],'县':['宁河县','静海县','蓟　县']},
'重庆':{'市辖区':['万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','万盛区','双桥区','渝北区','巴南区','黔江区','长寿区'],'县':['綦江县','潼南县','铜梁县','大足县','荣昌县','璧山县','梁平县','城口县','丰都县','垫江县','武隆县','忠　县','开　县','云阳县','奉节县','巫山县','巫溪县','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县'],'市':['江津市','合川市','永川市','南川市']},
'四川':{'成都市':['市辖区','锦江区','青羊区','金牛区','武侯区','成华区','龙泉驿区','青白江区','新都区','温江县','金堂县','双流县','郫　县','大邑县','蒲江县','新津县','都江堰市','彭州市','邛崃市','崇州市'],		   
...
'贵州':{'贵阳市':['市辖区','南明区','云岩区','花溪区','乌当区','白云区','小河区','开阳县','息烽县','修文县','清镇市'],		   
...
'云南':{'昆明市':['市辖区','五华区','盘龙区','官渡区','西山区','东川区','呈贡县','晋宁县','富民县','宜良县','石林彝族自治县','嵩明县','禄劝彝族苗族自治县','寻甸回族彝族自治县','安宁市'],		   
...
'西藏':{'拉萨市':['市辖区','城关区','林周县','当雄县','尼木县','曲水县','堆龙德庆县','达孜县','墨竹工卡县'],		   
...
'河南':{'郑州市':['市辖区','中原区','二七区','管城回族区','金水区','上街区','邙山区','中牟县','巩义市','荥阳市','新密市','新郑市','登封市'],		   
...
'湖北':{'武汉市':['市辖区','江岸区','江汉区','乔口区','汉阳区','武昌区','青山区','洪山区','东西湖区','汉南区','蔡甸区','江夏区','黄陂区','新洲区'],		   
...
'湖南':{'长沙市':['市辖区','芙蓉区','天心区','岳麓区','开福区','雨花区','长沙县','望城县','宁乡县','浏阳市'],		   
...
'广东':{'广州市':['市辖区','东山区','荔湾区','越秀区','海珠区','天河区','芳村区','白云区','黄埔区','番禺区','花都区','增城市','从化市'],		   
...
'广西':{'南宁市':['市辖区','兴宁区','青秀区','江南区','西乡塘区','良庆区','邕宁区','武鸣县','隆安县','马山县','上林县','宾阳县','横　县'],		   
...
'陕西':{'西安市':['市辖区','新城区','碑林区','莲湖区','灞桥区','未央区','雁塔区','阎良区','临潼区','长安区','蓝田县','周至县','户　县','高陵县'],		   
...
'澳门':{}};
	...
	$scope.loadAddressData = function(){
		$http.post(ApiEndpoint.url + '/api_address_list?userId='+(Userinfo.l.id?Userinfo.l.id:"")).success(function(data) {
			if (data.state == 'success') {
				$scope.addressdatalist = data.list;
				$ionicLoading.hide();
			}
		});
	}
	$scope.loadAddressData();
	$scope.address_default = function(id){
		$http.post(ApiEndpoint.url + '/api_address_default?id='+id).success(function(data) {
	...
	$scope.show_address = function(id){
		...
		if(id!=''){
			$http.post(ApiEndpoint.url + '/api_address_get?id='+id).success(function(data) {
				console.log(data);
				if (data.state =="success") {
					$scope.addressObj = data.obj;
					$scope.address=data.obj;
					console.log(data.obj.province);
					$scope.address.province='重庆市';
					//$scope.address.province = data.obj.province;
					console.log($scope.address);
//					$("#telephone").val(data.obj.telephone);
//					$("#zipCode").val(data.obj.zipCode);
//					$("#cmbProvince").val(data.obj.province);
//					$("#cmbCity").val(data.obj.city);
//					$("#cmbArea").val(data.obj.county);
//					$("#locations").val(data.obj.locations);
